...
// node_modules/.pnpm/components@https+++codeload.github.com+nuqayah+components+tar.gz+refs+tags+v2.0.49/node_modules/components/src/util.js
...
function median(values) {
  ...
  return array.length % 2 ? array[middle] : (array[middle - 1] + array[middle]) / 2;
}
...
function prep_ar_query_gapped(q, strip_regex = /[^\p{sc=Arabic}\p{N} ]/gu) {
...
function relative_time(rtf, d1, d2 = /* @__PURE__ */ new Date()) {
  const units = [
    ["year", 31536e3],
    ["month", 2628e3],
    ["day", 86400],
  ...
  const elapsed_abs = Math.max(Math.abs(elapsed), 1e3);
  const [unit, value] = units.find(([, value2]) => elapsed_abs >= value2);
...
focus-trap/dist/focus-trap.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-JGOHEBIE.js.map
